...
function (e, t) {
    ...
    function i(e) {
        ...
        for (t = "", i = 0, n = e.length; n > i; i++) a = e.charAt(i), t += O[a] || a;
        return t
    }
    ...
    function o(t, i) {
        ...
        for (n = t.split(i), a = 0, s = n.length; s > a; a += 1) n[a] = e.trim(n[a]);
        return n
    }
    ...
    function v(t) {
        if (!M) {
            ...
            M = e(document.createElement("div")).css({
                ...
                whiteSpace: "nowrap"
            }), M.attr("class", "select2-sizer"), e("body").append(M)
        }
    ...
    function b(t, i, n) {
        ...
        a = t.attr("class"), a && (a = "" + a, e(a.split(" ")).each2(function () {
            ...
            0 !== this.indexOf("select2-") && (s = n(this), s && o.push(this))
        })), t.attr("class", o.join(" "))
    }

    function y(e, t, n, a) {
        var s = i(e.toUpperCase()).indexOf(i(t.toUpperCase())),
            o = t.length;
        return 0 > s ? (n.push(a(e)), void 0) : (n.push(a(e.substring(0, s))), n.push("<span class='select2-match'>"), n.push(a(e.substring(s, s + o))), n.push("</span>"), n.push(a(e.substring(s + o, e.length))), void 0)
    }
    ...
    function C(i) {
        ...
        return function (l) {
            window.clearTimeout(n), n = window.setTimeout(function () {
                ...
                n = n ? n.call(r, l.term, l.page, l.context) : null, s = "function" == typeof s ? s.call(r, l.term, l.page, l.context) : s, a && a.abort(), i.params && (e.isFunction(i.params) ? e.extend(h, i.params.call(r)) : e.extend(h, i.params)), e.extend(h, {
                    url: s,
                    dataType: i.dataType,
                    data: n,
                    success: function (e) {
    ...
    function w(t) {
        ...
        var o = a();
        return o.text && (s = o.text, e.isFunction(s) || (i = o.text, s = function (e) {
            return e[i]
        })),
        function (t) {
            var i, n = t.term,
            ...
            return "" === n ? (t.callback(a()), void 0) : (i = function (a, o) {
                ...
                if (a = a[0], a.children) {
                    ...
                    r.children = [], e(a.children).each2(function (e, t) {
                        i(t, r.children)
                    }), (r.children.length || t.matcher(n, s(r), a)) && o.push(r)
                } else t.matcher(n, s(a), a) && o.push(a)
    ...
    function x(i) {
        ...
        return function (a) {
            ...
            e(n ? i() : i).each(function () {
                var e = this.text !== t,
                    i = e ? this.text : this;
                ("" === s || a.matcher(s, i)) && o.results.push(e ? this : {
                        id: this,
                        text: this
                    })
            }), a.callback(o)
    ...
    function S(e, i, n, a) {
        ...
        for (;;) {
            for (r = -1, l = 0, c = a.tokenSeparators.length; c > l && (u = a.tokenSeparators[l], r = e.indexOf(u), !(r >= 0)); l++);
            if (0 > r) break;
            if (o = e.substring(0, r), e = e.substring(r + u.length), o.length > 0 && (o = a.createSearchChoice.call(this, o, i), o !== t && null !== o && a.id(o) !== t && null !== a.id(o))) {
                for (d = !1, l = 0, c = i.length; c > l; l++)
                    if (s(a.id(o), a.id(i[l]))) {
                        d = !0;
                        break
                    }
                d || n(o)
    ...
    if (window.Select2 === t) {
        ...
        N = e(document), P = function () {
            ...
            init: function (i) {
                var n, s, o, r, u = ".select2-results";
                this.opts = i = this.prepareOpts(i), this.id = i.id, i.element.data("select2") !== t && null !== i.element.data("select2") && i.element.data("select2").destroy(), this.container = this.createContainer(), this.containerId = "s2id_" + (i.element.attr("id") || "autogen" + P()), this.containerSelector = "#" + this.containerId.replace(/([;&,\.\+\*\~':"\!\^#$%@\[\]\(\)=>\|])/g, "\\$1"), this.container.attr("id", this.containerId), this.body = h(function () {
                    return i.element.closest("body")
                }), b(this.container, this.opts.element, this.opts.adaptContainerCssClass), this.container.attr("style", i.element.attr("style")), this.container.css(T(i.containerCss)), this.container.addClass(T(i.containerCssClass)), this.elementTabIndex = this.opts.element.attr("tabindex"), this.opts.element.data("select2", this).attr("tabindex", "-1").before(this.container).on("click.select2", g), this.container.data("select2", this), this.dropdown = this.container.find(".select2-drop"), b(this.dropdown, this.opts.element, this.opts.adaptDropdownCssClass), this.dropdown.addClass(T(i.dropdownCssClass)), this.dropdown.data("select2", this), this.dropdown.on("click", g), this.results = n = this.container.find(u), this.search = s = this.container.find("input.select2-input"), this.queryCount = 0, this.resultsPage = 0, this.context = null, this.initContainer(), this.container.on("click", g), c(this.results), this.dropdown.on("mousemove-filtered touchstart touchmove touchend", u, this.bind(this.highlightUnderEvent)), d(80, this.results), this.dropdown.on("scroll-debounced", u, this.bind(this.loadMoreIfNeeded)), e(this.container).on("change", ".select2-input", function (e) {
                    e.stopPropagation()
                }), e(this.dropdown).on("change", ".select2-input", function (e) {
                    e.stopPropagation()
                }), e.fn.mousewheel && n.mousewheel(function (e, t, i, a) {
                    var s = n.scrollTop();
                    a > 0 && 0 >= s - a ? (n.scrollTop(0), g(e)) : 0 > a && n.get(0).scrollHeight - n.scrollTop() + a <= n.height() && (n.scrollTop(n.get(0).scrollHeight - n.height()), g(e))
                ...
                }), this.dropdown.on("mouseup", u, this.bind(function (t) {
                ...
                r === t && (r = !1), this.readonly(r), j = j || a(), this.autofocus = i.element.prop("autofocus"), i.element.prop("autofocus", !1), this.autofocus && this.focus(), this.nextSearchTerm = t
            },
            destroy: function () {
            ...
            prepareOpts: function (i) {
                ...
                if (n = i.element, "select" === n.get(0).tagName.toLowerCase() && (this.select = a = i.element), a && e.each(["id", "multiple", "ajax", "query", "createSearchChoice", "initSelection", "data", "tags"], function () {
                    ...
                    populateResults: function (n, a, s) {
                        var o, r = this.opts.id;
                        o = function (n, a, l) {
                            var u, h, d, p, f, g, m, v, b, y;
                            for (n = i.sortResults(n, a, s), u = 0, h = n.length; h > u; u += 1) d = n[u], f = d.disabled === !0, p = !f && r(d) !== t, g = d.children && d.children.length > 0, m = e("<li></li>"), m.addClass("select2-results-dept-" + l), m.addClass("select2-result"), m.addClass(p ? "select2-result-selectable" : "select2-result-unselectable"), f && m.addClass("select2-disabled"), g && m.addClass("select2-result-with-children"), m.addClass(c.opts.formatResultCssClass(d)), v = e(document.createElement("div")), v.addClass("select2-result-label"), y = i.formatResult(d, v, s, c.opts.escapeMarkup), y !== t && v.html(y), m.append(v), g && (b = e("<ul></ul>"), b.addClass("select2-result-sub"), o(d.children, b, l + 1), m.append(b)), m.data("select2-data", d), a.append(m)
                        }, o(a, n, 0)
                    }
                ...
                if (a ? (i.query = this.bind(function (e) {
                    ...
                    return e.css
                }) : "query" in i || ("ajax" in i ? (l = i.element.data("ajax-url"), l && l.length > 0 && (i.ajax.url = l), i.query = C.call(i.element, i.ajax)) : "data" in i ? i.query = w(i.data) : "tags" in i && (i.query = x(i.tags), i.createSearchChoice === t && (i.createSearchChoice = function (t) {
                    return {
                        id: e.trim(t),
                        text: e.trim(t)
                    }
            ...
            monitorSource: function () {
                ...
                i.on("change.select2", this.bind(function () {
                    ...
                    e === t && (e = !1), this.readonly(e), b(this.container, this.opts.element, this.opts.adaptContainerCssClass), this.container.addClass(T(this.opts.containerCssClass)), b(this.dropdown, this.opts.element, this.opts.adaptDropdownCssClass), this.dropdown.addClass(T(this.opts.dropdownCssClass))
            ...
            positionDropdown: function () {
                var t, i, n, a, s = this.dropdown,
                    ...
                    d = o.left,
                    p = u >= h + l,
                    f = o.top - l >= this.body().scrollTop(),
                    g = s.outerWidth(!1),
                    m = c >= d + g,
                    v = s.hasClass("select2-drop-above");
                if (App.isIE8() || App.isIE9()) var b = this.container.outerWidth(!1);
                else var b = window.getComputedStyle(this.container[0]).width;
                this.opts.dropdownAutoWidth ? (a = e(".select2-results", s)[0], s.addClass("select2-drop-auto-width"), s.css("width", ""), g = s.outerWidth(!1) + (a.scrollHeight === a.clientHeight ? 0 : j.width), g > b ? b = g : g = b, m = c >= d + g) : this.container.removeClass("select2-drop-auto-width"), "static" !== this.body().css("position") && (t = this.body().offset(), h -= t.top, d -= t.left), v ? (i = !0, !f && p && (i = !1)) : (i = !1, !p && f && (i = !0)), m || (d = o.left + b - g), i ? (h = o.top - l, this.container.addClass("select2-drop-above"), s.addClass("select2-drop-above")) : (this.container.removeClass("select2-drop-above"), s.removeClass("select2-drop-above")), n = e.extend({
                    top: h,
                    left: d,
                    width: b
                }, T(this.opts.dropdownCss)), s.css(n)
            },
            shouldOpen: function () {
                var t;
            ...
            ensureHighlightVisible: function () {
                var t, i, n, a, s, o, r, l = this.results;
                if (i = this.highlight(), !(0 > i)) {
                    if (0 == i) return l.scrollTop(0), void 0;
                    t = this.findHighlightableChoices().find(".select2-result-label"), n = e(t[i]), a = n.offset().top + n.outerHeight(!0), i === t.length - 1 && (r = l.find("li.select2-more-results"), r.length > 0 && (a = r.offset().top + r.outerHeight(!0))), s = l.offset().top + l.outerHeight(!0), a > s && l.scrollTop(l.scrollTop() + (a - s)), o = n.offset().top - l.offset().top, 0 > o && "none" != n.css("display") && l.scrollTop(l.scrollTop() + o)
                }
            },
            ...
            highlight: function (t) {
                var i, a, s = this.findHighlightableChoices();
                return 0 === arguments.length ? n(s.filter(".select2-highlighted")[0], s.get()) : (t >= s.length && (t = s.length - 1), 0 > t && (t = 0), this.removeHighlight(), i = e(s[t]), i.addClass("select2-highlighted"), this.ensureHighlightVisible(), a = i.data("select2-data"), a && this.opts.element.trigger({
            ...
            updateResults: function (i) {
                ...
                if ((i === !0 || !f || !s(p, f)) && (e.data(this.container, "select2-last-term", p), i === !0 || this.showSearchInput !== !1 && this.opened())) {
                    ...
                    if (g >= 1 && (o = this.data(), e.isArray(o) && o.length >= g && D(h.formatSelectionTooBig, "formatSelectionTooBig"))) return a("<li class='select2-selection-limit'>" + h.formatSelectionTooBig(g) + "</li>"), void 0;
                    if (c.val().length < h.minimumInputLength) return D(h.formatInputTooShort, "formatInputTooShort") ? a("<li class='select2-no-results'>" + h.formatInputTooShort(c.val(), h.minimumInputLength) + "</li>") : a(""), i && this.showSearch && this.showSearch(!0), void 0;
                    if (h.maximumInputLength && c.val().length > h.maximumInputLength) return D(h.formatInputTooLong, "formatInputTooLong") ? a("<li class='select2-no-results'>" + h.formatInputTooLong(c.val(), h.maximumInputLength) + "</li>") : a(""), void 0;
                    h.formatSearching && 0 === this.findHighlightableChoices().length && a("<li class='select2-searching'>" + h.formatSearching() + "</li>"), c.addClass("select2-active"), this.removeHighlight(), r = this.tokenize(), r != t && null != r && c.val(r), this.resultsPage = 1, h.query({
                        element: h.element,
                        term: c.val(),
                        ...
                        callback: this.bind(function (o) {
                            ...
                            if (l == this.queryCount) {
                                ...
                                if (this.context = o.context === t ? null : o.context, this.opts.createSearchChoice && "" !== c.val() && (r = this.opts.createSearchChoice.call(d, c.val(), o.results), r !== t && null !== r && d.id(r) !== t && null !== d.id(r) && 0 === e(o.results).filter(function () {
                                    return s(d.id(this), d.id(r))
                                }).length && o.results.unshift(r)), 0 === o.results.length && D(h.formatNoMatches, "formatNoMatches")) return a("<li class='select2-no-results'>" + h.formatNoMatches(c.val()) + "</li>"), void 0;
                                u.empty(), d.opts.populateResults.call(this, u, o.results, {
                                    term: c.val(),
                                    page: this.resultsPage,
                                    context: null
                                }), o.more === !0 && D(h.formatLoadMore, "formatLoadMore") && (u.append("<li class='select2-more-results'>" + d.opts.escapeMarkup(h.formatLoadMore(this.resultsPage)) + "</li>"), window.setTimeout(function () {
                                    d.loadMoreIfNeeded()
                ...
                function i() {
                    ...
                    if ("copy" === this.opts.width || "resolve" === this.opts.width) {
                        if (i = this.opts.element.attr("style"), i !== t)
                            for (n = i.split(";"), s = 0, o = n.length; o > s; s += 1)
                                if (a = n[s].replace(/\s/g, "").match(/[^-]width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i), null !== a && a.length >= 1) return a[1];
            ...
            initContainer: function () {
                var t, i = this.container,
                    n = this.dropdown;
                this.opts.minimumResultsForSearch < 0 ? this.showSearch(!1) : this.showSearch(!0), this.selection = t = i.find(".select2-choice"), this.focusser = i.find(".select2-focusser"), this.focusser.attr("id", "s2id_autogen" + P()), e("label[for='" + this.opts.element.attr("id") + "']").attr("for", this.focusser.attr("id")), this.focusser.attr("tabindex", this.elementTabIndex), this.search.on("keydown", this.bind(function (e) {
                    if (this.isInterfaceEnabled()) {
                        if (e.which === E.PAGE_UP || e.which === E.PAGE_DOWN) return g(e), void 0;
                        switch (e.which) {
                        case E.UP:
                        case E.DOWN:
                            return this.moveHighlight(e.which === E.UP ? -1 : 1), g(e), void 0;
                        case E.ENTER:
                            return this.selectHighlighted(), g(e), void 0;
                        case E.TAB:
                            return this.selectHighlighted({
                                noFocus: !0
                            }), void 0;
                        case E.ESC:
                            return this.cancel(e), g(e), void 0
                        }
                    }
                    ...
                    if (this.isInterfaceEnabled() && e.which !== E.TAB && !E.isControl(e) && !E.isFunctionKey(e) && e.which !== E.ESC) {
                        if (this.opts.openOnEnter === !1 && e.which === E.ENTER) return g(e), void 0;
                        if (e.which == E.DOWN || e.which == E.UP || e.which == E.ENTER && this.opts.openOnEnter) {
                            if (e.altKey || e.ctrlKey || e.shiftKey || e.metaKey) return;
                            return this.open(), g(e), void 0
                        }
                        return e.which == E.DELETE || e.which == E.BACKSPACE ? (this.opts.allowClear && this.clear(), g(e), void 0) : void 0
                    }
            ...
            postprocessResults: function (e, t, i) {
                ...
                if (this.findHighlightableChoices().each2(function (e, t) {
                    return s(a.id(t.data("select2-data")), a.opts.element.val()) ? (n = e, !1) : void 0
            ...
            onSelect: function (e, t) {
                if (this.triggerSelect(e)) {
                    ...
                    this.opts.element.val(this.id(e)), this.updateSelection(e), this.opts.element.trigger({
                        ...
                        val: this.id(e),
                        choice: e
                    }), this.nextSearchTerm = this.opts.nextSearchTerm(e, this.search.val()), this.close(), t && t.noFocus || this.focusser.focus(), s(i, this.id(e)) || this.triggerChange({
                        added: e,
                        removed: n
                    })
                }
                ...
                this.selection.on("click", ".select2-search-choice:not(.select2-locked)", function () {
                    ...
                    if (this.isInterfaceEnabled()) {
                        ...
                        var i = t.find(".select2-search-choice-focus"),
                            ...
                            s = f(this.search);
                        if (i.length && (e.which == E.LEFT || e.which == E.RIGHT || e.which == E.BACKSPACE || e.which == E.DELETE || e.which == E.ENTER)) {
                            var o = i;
                            return e.which == E.LEFT && n.length ? o = n : e.which == E.RIGHT ? o = a.length ? a : null : e.which === E.BACKSPACE ? (this.unselect(i.first()), this.search.width(10), o = n.length ? n : a) : e.which == E.DELETE ? (this.unselect(i.first()), this.search.width(10), o = a.length ? a : null) : e.which == E.ENTER && (o = null), this.selectChoice(o), g(e), o && o.length || this.open(), void 0
                        }
                        if ((e.which === E.BACKSPACE && 1 == this.keydowns || e.which == E.LEFT) && 0 == s.offset && !s.length) return this.selectChoice(t.find(".select2-search-choice:not(.select2-locked)").last()), g(e), void 0;
                        ...
                        if (e.which !== E.TAB && !E.isControl(e) && !E.isFunctionKey(e) && e.which !== E.BACKSPACE && e.which !== E.ESC) {
                            ...
                            this.open(), (e.which === E.PAGE_UP || e.which === E.PAGE_DOWN) && g(e), e.which === E.ENTER && g(e)
                        }
                    }
            ...
            updateSelection: function (t) {
                var i = [],
                    ...
                    s = this;
                e(t).each(function () {
                    n(s.id(this), i) < 0 && (i.push(s.id(this)), a.push(this))
            ...
            addSelectedChoice: function (i) {
                var n, a, s = !i.locked,
                    ...
                    c = this.id(i),
                    u = this.getVal();
                n = this.opts.formatSelection(i, l.find("div"), this.opts.escapeMarkup), n != t && l.find("div").replaceWith("<div>" + n + "</div>"), a = this.opts.formatSelectionCssClass(i, l.find("div")), a != t && l.addClass(a), s && l.find(".select2-search-choice-close").on("mousedown", g).on("click dblclick", this.bind(function (t) {
            ...
            resizeSearch: function () {
                var e, t, i, n, a, s = r(this.search);
                e = v(this.search) + 10, t = this.search.offset().left, i = this.selection.width(), n = this.selection.offset().left, a = i - (t - n) - s, e > a && (a = i - s), 40 > a && (a = i - s), 0 >= a && (a = e), this.search.width(Math.floor(a))
            },
            getVal: function () {
                var e;
            ...
            buildChangeDetails: function (e, t) {
                for (var t = t.slice(0), e = e.slice(0), i = 0; i < t.length; i++)
                    for (var n = 0; n < e.length; n++) s(this.opts.id(t[i]), this.opts.id(e[n])) && (t.splice(i, 1), i--, e.splice(n, 1), n--);
                return {
                    added: t,
                    removed: e
                }
            ...
            val: function (i, n) {
                ...
                if (this.setVal(i), this.select) this.opts.initSelection(this.select, this.bind(this.updateSelection)), n && this.triggerChange(this.buildChangeDetails(a, this.data()));
                    ...
                    this.opts.initSelection(this.opts.element, function (t) {
                        var i = e.map(t, s.id);
                        s.setVal(i), s.updateSelection(t), s.clearSearch(), n && s.triggerChange(s.buildChangeDetails(a, this.data()))
                    })
                }
                this.clearSearch()
            },
            ...
            var i, a, s, o, r, l = Array.prototype.slice.call(arguments, 0),
            ...
            return this.each(function () {
                if (0 === l.length || "object" == typeof l[0]) i = 0 === l.length ? {} : e.extend({}, l[0]), i.element = e(this), "select" === i.element.get(0).tagName.toLowerCase() ? r = i.element.prop("multiple") : (r = i.multiple || !1, "tags" in i && (i.multiple = r = !0)), a = r ? new $ : new A, a.init(i);
                else {
                    ...
                    if (s = l[0], "container" === s ? o = a.container : "dropdown" === s ? o = a.dropdown : (d[s] && (s = d[s]), o = a[s].apply(a, l.slice(1))), n(l[0], u) >= 0 || n(l[0], h) && 1 == l.length) return !1
                }
            }), o === t ? this : o
            ...
            formatResult: function (e, t, i, n) {
                var a = [];
                return y(e.text, i.term, a, n), a.join("")
            },
