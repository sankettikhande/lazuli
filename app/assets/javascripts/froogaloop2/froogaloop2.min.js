...
$( document ).ready(function() {
	var player = $('#player_1')[0];
	  ...
	  video_share_token = $("#share_video_token").data("token");
	  share_views_count_url = "/count/user_share_videos/"+ video_share_token
	  ...
	  function ready(player_id) {
	    ...
	    function onPlay(watch_list_url, history_list_url,share_views_count_url) {
	      froogaloop.addEvent('play', function(data) {
	        watch_list(watch_list_url)
	        history(history_list_url)
	        view_count(share_views_count_url)
	      });
	    }
	    ...
	    function view_count(url){
	    	if ($("#share_video_token").data("token_validity") == true){
	    		$.ajax({
	    		url: url
	    		});
	    	}
	    ...
	    onPlay(watch_list_url, history_list_url,share_views_count_url);
	  }
	});