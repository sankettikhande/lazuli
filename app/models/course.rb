class Course < ActiveRecord::Base
  ...
  attr_accessible :name, :description, :trainer_name, :trainer_biography, :image, :course_permissions_attributes, :channel_courses_attributes
  ...
  accepts_nested_attributes_for :course_permissions, :channel_courses
  #SCOPES
