json.aaData @courses do |course|
  json.name link_to(course.name, course_videos_admin_course_url(course, :col => 'course_name'), :remote => true)
  json.(course, :trainer_name, :channel_name, :course_admin_user, :user_count)
