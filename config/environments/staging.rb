Lazuli::Application.configure do
  ...
  config.assets.precompile += %w( ie.js admin.js utils.js admin.css admin/app_functions/* admin/jquery.dataTables.js admin/DT_bootstrap.js admin/jquery.form.js application/main_app/* froogaloop2/* jquery-star-rating.js application/html5shiv.js)
